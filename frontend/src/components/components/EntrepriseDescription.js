...
const EntrepriseDescription = () => {
  ...
  return (
    <div className='flex flex-col gap-y-10'>
      <span className='font-bold text-3xl tracking-wide'>Bienvenue sur CARBOcount !</span>
      <div className='w-[40rem] h-auto font-[480] text-lg leading-10 tracking-tight '>
        Prenez le contrôle de votre <span className='text-[#C51605] font-medium'>empreinte carbone</span> dès aujourd'hui ! <br/> Cliquez sur le <span className='text-[#FD8D14] font-medium'>bouton</span> pour évaluer votre bilan carbone et contribuer à un avenir <span className='text-[#CECE5A] font-medium'>plus durable</span> pour votre entreprise et notre planète.
      </div>
        <CustomButton
